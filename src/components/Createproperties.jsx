...
import { useState } from "react";
    ...
    function CreateProperties() {
        ...
        return (<form onSubmit={e => {
            e.preventDefault();
            axios.post("http://localhost:5000/properties", {address, offersinregionof, typeofproperty, squarefootage, bedrooms, bathrooms, garden, outbuildings, freehold, sellerid, uploadimages })
                .then(response => {
